...
TEXT_1 = "ОБРАТИТЕ ВНИМАНИЕ!!! Большинство запчастей в нашем магазине представлены на ПРАВОРУКИЕ авто, если машина леворукая это указано в комментариях, некоторые запчасти могут быть отличаться  ЛЕВЫЙ руль ППРАВЫЙ руль !!!" # ≠ не кодируется
