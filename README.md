...
Результирующие файлы создаются в этой же папке и называются <b>result_avito.csv</b> (для загрузки на Авито) и <b>result_local.csv</b> (в кодировке для чтения на windows)<br>
